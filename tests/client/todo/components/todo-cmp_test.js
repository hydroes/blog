...
testing_1.describe('todo_component', function () {
    ...
    testing_1.describe('creation', function () {
        testing_1.it('should create the component correctly', testing_1.injectAsync([testing_2.TestComponentBuilder], function (tcb) {
        ...
        testing_1.it('should inicialize the cmp correctly', testing_1.injectAsync([testing_2.TestComponentBuilder], function (tcb) {
            return tcb.createAsync(todo_cmp_1.TodoCmp).then(function (fixture) {
        ...
        testing_1.it('should call add correctly', testing_1.injectAsync([testing_2.TestComponentBuilder], function (tcb) {
            return tcb.createAsync(todo_cmp_1.TodoCmp).then(function (fixture) {
                fixture.detectChanges();
                var instance = fixture.debugElement.componentInstance;
                var _todoMsg = 'yo';
        ...
        testing_1.it('should call remove correctly', testing_1.injectAsync([testing_2.TestComponentBuilder], function (tcb) {
            return tcb.createAsync(todo_cmp_1.TodoCmp).then(function (fixture) {
                fixture.detectChanges();
                var instance = fixture.debugElement.componentInstance;
                var _id = 'abc123';
